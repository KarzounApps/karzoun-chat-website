        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 text-right">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://karzoun.chat/terms-of-service/" className="text-gray-600 hover:text-google-blue">
                  شروط الاستخدام
                </a>
              </li>
              <li>
                <a href="https://karzoun.chat/privacy-policy/" className="text-gray-600 hover:text-google-blue">
                  السياسة الخصوصية
                </a>
              </li>
              <li>
