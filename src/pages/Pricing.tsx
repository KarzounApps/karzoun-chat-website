...
import { 
  Check, Star, Users, Building2, Building, 
  Shield, Clock, Zap, ArrowRight, ChevronLeft,
  MessageSquare, Bot, BarChart, Users2, Headphones,
  Infinity, Award, Crown
} from 'lucide-react';
            ...
            {plans.map((plan, index) => (
              <motion.div
                ...
                className={`relative bg-white rounded-2xl p-8 ${
                  plan.popular 
                    ? 'ring-4 ring-google-blue ring-opacity-20 shadow-xl transform hover:-translate-y-1'
              ...
              >
                ...
                <div className="mb-8">
                  <div className="flex items-baseline">
                    ...
                    <span className="text-gray-500 mr-2">
                      / {billingInterval === 'monthly' ? 'شهرياً' : 'سنوياً'}
                    </span>
                  </div>
                </div>
                ...
                <button className={`w-full rounded-xl py-4 px-6 font-semibold transition-all duration-300 ${
                  plan.popular
