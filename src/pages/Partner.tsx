...
import { 
  Building2, Rocket, Users, Globe2, Shield, 
  Award, Zap, ArrowRight, BarChart, Settings,
  Palette, Code2, Cloud, DollarSign, HeartHandshake,
  Boxes, UserCheck, Megaphone, BrainCircuit, Target,
  Briefcase, BadgeCheck, TrendingUp, Layers, Store,
  Coins, Laptop, Users2
} from 'lucide-react';
...
const partnerTypes = [
  {
    ...
    benefits: [
      "دمج سلس مع خدمات وكالتك",
      "عمولات مجزية على المبيعات",
      "دعم تسويقي متخصص",
      "تدريب فريق المبيعات"
    ]
  },
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              اختر نموذج الشراكة المناسب لأعمالك. سواء كنت تبحث عن برنامج العمولات
              أو حل العلامة البيضاء المتكامل، نحن هنا لدعم نجاحك.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              برنامجان مصممان لتلبية احتياجات مختلف الشركاء
            </p>
              ...
              {commissionProgram.tiers.map((tier, index) => (
                ...
                >
                  ...
                  <div className="flex items-baseline gap-1 mb-6">
                    <span className="text-3xl font-bold text-google-blue">
                      {tier.commission}
                    </span>
                    <span className="text-gray-500">عمولة</span>
                  </div>
                  <p className="text-gray-600 mb-4">
                    الحد الأدنى للإيرادات: {tier.minRevenue}
                  </p>
                ...
                {whitelabelProgram.tiers.map((tier, index) => (
                  ...
                  >
                    ...
                    <p className="text-gray-600 mb-6">
                      الحد الأدنى للإيرادات السنوية: {tier.revenue}
                    </p>
                    <ul className="space-y-3">
                      {tier.features.map((feature, i) => (
                        <li key={i} className="flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              انضم إلى مئات الشركاء الناجحين في شبكتنا
            </p>
          </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            ابدأ رحلتك معنا اليوم وكن جزءاً من مستقبل خدمة العملاء
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
