...
const modelRates: ModelRate[] = [
  ...
  { 
    ...
    capabilities: [
      "إنشاء صور واقعية",
      "تحويل الأفكار النصية إلى صور",
      "تخصيص الأسلوب الفني",
      "إنشاء تصاميم إبداعية"
    ],
    useCases: [
      "التصميم الجرافيكي",
  ...
  { 
    ...
    useCases: [
      ...
      "أنظمة التوصية",
      "تصنيف المستندات",
      "الأسئلة والأجوبة على قواعد البيانات"
    ],
    icon: Layers,
    color: "orange"
  }
...
const faqData = [
  {
    ...
    answer: "التوكنز هي وحدات النص التي يفهمها نموذج الذكاء الاصطناعي. يمكن أن يكون التوكن حرفًا واحدًا أو كلمة أو جزءًا من كلمة، اعتمادًا على اللغة والسياق. في اللغة الإنجليزية، يعادل 1 توكن حوالي 4 أحرف أو 0.75 كلمة. في اللغة العربية، قد يختلف هذا المعدل قليلاً. يتم احتساب التكلفة بناءً على عدد التوكنز المستخدمة في كل من المدخلات (الأسئلة) والمخرجات (الإجابات)."
  },
  {
    question: "ما الفرق بين توكنز المدخلات وتوكنز المخرجات؟",
    answer: "توكنز المدخلات هي التوكنز المستخدمة في الأسئلة أو التعليمات التي ترسلها إلى النموذج. توكنز المخرجات هي التوكنز المستخدمة في الإجابات التي ينتجها النموذج. عادةً ما تكون تكلفة توكنز المخرجات أعلى من تكلفة توكنز المدخلات."
  },
  {
    question: "ما هو حجم نافذة السياق (Context Window)؟",
    answer: "نافذة السياق هي الحد الأقصى لعدد التوكنز التي يمكن للنموذج معالجتها في طلب واحد، وتشمل كلاً من المدخلات والمخرجات. على سبيل المثال، إذا كان حجم نافذة السياق 8192 توكن، فهذا يعني أن مجموع توكنز المدخلات والمخرجات لا يمكن أن يتجاوز 8192 توكن في الطلب الواحد."
  },
  {
    question: "كيف يمكنني تقدير عدد التوكنز في النص؟",
    answer: "كقاعدة عامة، يمكن تقدير عدد التوكنز في النص الإنجليزي بقسمة عدد الكلمات على 0.75 (أو ضرب عدد الكلمات في 1.33). للنص العربي، قد تختلف النسبة قليلاً. للحصول على تقدير أكثر دقة، يمكنك استخدام أداة تقدير التوكنز المتوفرة في واجهة برمجة التطبيقات الخاصة بنا."
  },
  {
    question: "هل هناك حد أدنى للفواتير؟",
    answer: "لا، نحن نفرض رسومًا فقط على الاستخدام الفعلي للتوكنز. لا يوجد حد أدنى للفواتير أو رسوم ثابتة. ومع ذلك، قد تكون هناك باقات اشتراك مختلفة توفر أسعارًا مخفضة للاستخدام العالي."
  },
  {
    question: "هل يمكنني وضع حد أقصى للإنفاق؟",
    answer: "نعم، يمكنك تعيين حد أقصى للإنفاق الشهري من خلال لوحة التحكم الخاصة بك. عندما تصل إلى هذا الحد، سيتم إيقاف الطلبات الجديدة تلقائيًا حتى بداية الشهر التالي أو حتى تقوم بزيادة الحد."
  },
  {
    question: "هل هناك خصومات للاستخدام بكميات كبيرة؟",
    answer: "نعم، نحن نقدم خصومات للعملاء الذين يستخدمون كميات كبيرة من التوكنز. يرجى التواصل مع فريق المبيعات لدينا لمناقشة الخيارات المتاحة لحالتك الخاصة."
  },
  {
    question: "ما هي سياسة الاسترداد؟",
    answer: "نحن لا نقدم استردادًا للتوكنز المستخدمة. ومع ذلك، في حالة حدوث أخطاء تقنية من جانبنا أدت إلى استهلاك توكنز إضافية، يمكننا تقديم رصيد لحسابك بعد مراجعة الحالة."
  }
];
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <ChevronDown className={`h-5 w-5 text-gray-400 transition-transform ${showModelDropdown ? 'transform rotate-180' : ''}`} />
                    </button>
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm text-gray-700">حجم نافذة السياق: {formatNumber(selectedModel.contextWindow)} توكن</span>
                  </div>
                    ...
                    <div>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        <div className="bg-indigo-50 rounded-lg p-4">
                          ...
                          <div className="text-xs text-gray-500">
                            {formatNumber(tokenUsage.input)} توكن × {formatCurrency(selectedModel.inputPrice / 1000)} / توكن
                          </div>
                        </div>
                        <div className="bg-purple-50 rounded-lg p-4">
                          ...
                          <div className="text-xs text-gray-500">
                            {formatNumber(tokenUsage.output)} توكن × {formatCurrency(selectedModel.outputPrice / 1000)} / توكن
                          </div>
                        </div>
                      ...
                      <div className="mb-6">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-sm font-medium">{calculationResult.inputTokenPercentage.toFixed(1)}%</span>
                        </div>
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                          ...
                          <span className="text-sm font-medium">{calculationResult.outputTokenPercentage.toFixed(1)}%</span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="bg-gray-50 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600">
                              حوالي {formatNumber(Math.floor(calculationResult.totalTokens / 800))} محادثة بمتوسط 800 توكن للمحادثة
                            </p>
                          </div>
                          <div className="bg-gray-50 rounded-lg p-4">
                            <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-sm text-gray-600">
                              حوالي {formatNumber(Math.floor(calculationResult.totalTokens / 500))} صفحة بمتوسط 500 توكن للصفحة
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="w-40 h-40 rounded-full border-8 border-indigo-500 relative overflow-hidden">
                            <div 
                              ...
                              style={{ 
                                clipPath: `polygon(0 0, 100% 0, 100% ${calculationResult.outputCost / calculationResult.totalCost * 100}%, 0 ${calculationResult.outputCost / calculationResult.totalCost * 100}%)` 
                              }} 
                            />
                          </div>
                        </div>
                  ...
                  <div className="bg-white rounded-xl shadow-md p-6">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        ...
                        <span className="text-sm text-gray-700">استخدم تعليمات واضحة ومختصرة لتقليل توكنز المدخلات</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 ml-2 flex-shrink-0 mt-0.5" />
                      ...
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 ml-2 flex-shrink-0 mt-0.5" />
                        <span className="text-sm text-gray-700">قم بتخزين نتائج الاستعلامات المتكررة لتجنب إعادة الحساب</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 ml-2 flex-shrink-0 mt-0.5" />
                        <span className="text-sm text-gray-700">استخدم التضمينات (Embeddings) للبحث في المستندات الكبيرة بدلاً من إرسالها كاملة</span>
                      </li>
                    </ul>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-indigo-700">
                      الأسعار المعروضة هي لكل 1000 توكن. التوكن هو وحدة قياس النص التي يستخدمها نموذج الذكاء الاصطناعي. في اللغة الإنجليزية، يعادل 1 توكن حوالي 4 أحرف أو 0.75 كلمة. قد تختلف هذه النسبة في اللغة العربية.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    >
                      <div className={`bg-${model.color}-50 p-4 border-b border-${model.color}-200`}>
                        <div className="flex items-center justify-between">
                          ...
                          <div className={`px-3 py-1 rounded-full bg-${model.color}-100 text-${model.color}-800 text-sm font-medium`}>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <div className="font-medium">
                            {formatNumber(example.avgInputTokens)} مدخلات / {formatNumber(example.avgOutputTokens)} مخرجات
                          </div>
                        </div>
                      </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="md:w-2/3">
                  ...
                  <p className="text-indigo-100 mb-6">
                    للشركات والمؤسسات التي تحتاج إلى حجم كبير من التوكنز أو تتطلب حلولًا مخصصة، نقدم باقات خاصة بأسعار تنافسية وميزات إضافية.
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-indigo-700 mb-4">
                    إذا كانت لديك أسئلة أخرى حول توكنز الذكاء الاصطناعي أو كيفية تحسين استخدامك للنماذج، فلا تتردد في التواصل مع فريق الدعم لدينا.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <a href="#" className="inline-flex items-center gap-1 bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-indigo-700 transition-colors">
                      <MessageSquare className="h-4 w-4" />
                      تحدث مع فريق الدعم
                    </a>
                    <a href="#" className="inline-flex items-center gap-1 bg-white text-indigo-700 border border-indigo-200 px-4 py-2 rounded-lg text-sm hover:bg-indigo-50 transition-colors">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-800 py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            جاهز لبدء استخدام نماذج كرزون للذكاء الاصطناعي؟
          </h2>
          <p className="text-xl text-indigo-100 max-w-3xl mx-auto mb-8">
            احصل على حلول ذكاء اصطناعي متقدمة تناسب احتياجات عملك وميزانيتك
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#" className="bg-white text-indigo-700 px-6 py-3 rounded-lg font-medium hover:bg-indigo-50 transition-colors">
              ابدأ الآن مجانًا
            </a>
            <a href="#" className="bg-indigo-700 text-white border border-indigo-500 px-6 py-3 rounded-lg font-medium hover:bg-indigo-600 transition-colors">
              تحدث مع مستشار
            </a>
          </div>
        </div>
