...
import { 
  Ticket, MessageSquare, Users, ArrowRight,
  Kanban, Filter, Clock, BarChart, Bot,
  Workflow, Layers, Zap
} from 'lucide-react';
        ...
        <div className="text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              إدارة التذاكر والمهام
              <span className="block text-[#2ca24c] mt-2">بكفاءة عالية</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              نظام متكامل لإدارة التذاكر والمهام مع خاصية تحويل المحادثات إلى مهام مباشرة. تتبع وأدر جميع طلبات العملاء من مكان واحد.
            </p>
          ...
          {[
            {
              icon: Kanban,
              title: "لوحات كانبان",
              description: "إدارة مرئية للمهام والتذاكر"
            },
            {
              icon: MessageSquare,
              title: "تحويل المحادثات",
              description: "تحويل المحادثات إلى مهام فوراً"
            },
            {
              icon: Workflow,
              title: "تدفقات العمل",
              description: "أتمتة تدفقات العمل والمهام"
            },
            {
              icon: BarChart,
              title: "تقارير متقدمة",
              description: "تحليلات شاملة للأداء والإنتاجية"
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
          ...
          <div className="bg-gray-900 rounded-xl overflow-hidden">
            ...
            <div className="bg-gray-800 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <Ticket className="h-6 w-6 text-[#2ca24c]" />
                <h3 className="text-lg font-medium text-white">إدارة التذاكر</h3>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-800 rounded-xl p-6">
                  <h4 className="text-lg font-medium text-white mb-4 flex items-center gap-2">
                    <Layers className="h-5 w-5 text-[#2ca24c]" />
                    المراحل النشطة
                  </h4>
                  ...
                  <div className="space-y-3">
                    <div className="bg-gray-700/50 p-4 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        <Zap className="h-4 w-4 text-[#f1b500]" />
                        <span className="text-gray-300">تعيين تلقائي للمهام</span>
                      </div>
                      <div className="flex gap-2">
                        {["عالية الأولوية", "الدعم الفني", "المبيعات"].map((tag, i) => (
