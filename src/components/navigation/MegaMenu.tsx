...
const featureItems = {
  ...
  التكامل: [
    ...
    },
    {
      ...
      link: "/features/salla-integration",
    },
    {
      icon: ShoppingCart,
      title: "زد",
      description: "ربط متجرك على منصة زد مع نظام خدمة العملاء",
      link: "/features/zid-integration",
    },
    {
      icon: FileText,
      title: "Google Sheets",
