...
const WhatsAppFlowsIndustries = () => {
  ...
  const industries = [
    ...
    },
    {
      ...
      name: 'العقارات',
      color: 'bg-green-500',
      description: 'تحسين تجربة البحث عن العقارات وزيادة المبيعات',
      useCases: [
        'استطلاع تفضيلات العملاء',
        'جولات افتراضية للعقارات',
        'حجز مواعيد المعاينة',
        'تقييم وتسعير العقارات'
      ],
      stats: {
        conversion: '200%',
        satisfaction: '92%',
      ...
      example: {
        title: 'مسار البحث عن عقار',
        steps: [
          'تحديد نوع العقار المطلوب',
          'اختيار المنطقة والميزانية',
          'تحديد المواصفات المطلوبة',
          'عرض العقارات المناسبة وحجز معاينة'
        ]
      }
    },
    {
