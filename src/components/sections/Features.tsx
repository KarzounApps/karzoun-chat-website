...
import { 
  Bot, GitBranch, MessageSquare, Settings, Users, 
  Zap, Send, Smartphone, Mail, Facebook, Instagram, 
  Calendar, Clock, BarChart, PieChart, LineChart, 
  ArrowRight, CheckCircle2, Globe, Database, Layers,
  BrainCircuit, Workflow, Sparkles, Lightbulb, Rocket
} from 'lucide-react';
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="space-y-6 flex-grow">
              ...
              <div className="mt-4 text-sm text-gray-600">
                <p>أنشئ حملات تسويقية مستهدفة عبر قنوات متعددة وتتبع أدائها في الوقت الفعلي. حدد العملاء المستهدفين وانطلق ببساطة.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl h-full p-6 shadow-sm border border-gray-100">
          <div className="flex flex-col h-full">
            ...
            <div className="space-y-6 flex-grow">
              ...
              <div className="mt-4 text-sm text-gray-600">
                <p>قم بأتمتة رحلات تسويقية لعملائك واترك الباقي لكرزون شات ليقوم بإدراج العملاء ضمن الحملات تلقائياً بإستخدام الذكاء الصناعي حسب شروطك الخاصة.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6 flex-grow">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {/* Integration Cards */}
                  {[
                    { name: "Shopify", icon: "https://cdn.worldvectorlogo.com/logos/shopify.svg", category: "متاجر إلكترونية" },
                    { name: "Salesforce", icon: "https://cdn.worldvectorlogo.com/logos/salesforce-2.svg", category: "CRM" },
                    { name: "HubSpot", icon: "https://cdn.worldvectorlogo.com/logos/hubspot.svg", category: "تسويق" },
                    { name: "Stripe", icon: "https://cdn.worldvectorlogo.com/logos/stripe-4.svg", category: "مدفوعات" },
                    { name: "Slack", icon: "https://cdn.worldvectorlogo.com/logos/slack-new-logo.svg", category: "تواصل" },
                    { name: "Google Analytics", icon: "https://cdn.worldvectorlogo.com/logos/google-analytics-4.svg", category: "تحليلات" }
                  ].map((app, index) => (
                    <div key={index} className="bg-white border border-gray-100 rounded-lg p-3 flex flex-col items-center shadow-sm">
              ...
              <div className="mt-4 text-sm text-gray-600">
                <p>قم بالتكامل مع منصاتك المفضلة بنقرة زر. احصل على تجربة تكامل ديناميكي ومتقدمة لم ترى لها مثيل من قبل.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl h-full p-6 shadow-sm border border-gray-100">
          <div className="flex flex-col h-full">
            ...
            <div className="space-y-6 flex-grow">
              ...
              <div className="mt-4 text-sm text-gray-600">
                <p>خصصنا لكم مساعد ذكي خاص ليقوم بمساعدتكم مع مختلف مميزات كرزون شات. يمكنك أيضاً خلق وتدريب المساعد الافتراضي الخاص بك وموظفيك حسب بنك معلوماتك.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            منشئ التدفقات المرئية للأتمتة المتقدمة
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            صمم رحلات عملاء متطورة مع واجهتنا السهلة للسحب والإفلات.
            اربط الإجراءات والمحفزات والشروط بسلاسة.
          </p>
        </motion.div>
