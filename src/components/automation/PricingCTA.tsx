...
import { 
  ...
  Workflow, Database, Code, Layers, Lock
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">
              ابدأ رحلتك مع أتمتة الأعمال
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              اختر الخطة المناسبة لاحتياجاتك وابدأ في تحسين كفاءة عملياتك اليوم
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {[
            {
              icon: Workflow,
              title: "تدفقات أتمتة متقدمة",
              description: "تصميم وتنفيذ تدفقات أتمتة معقدة بسهولة"
            },
            {
              icon: Database,
              title: "تكامل مع الأنظمة",
              description: "ربط سلس مع قواعد البيانات والأنظمة الخارجية"
            },
            {
              icon: Shield,
              title: "أمان متقدم",
              description: "حماية البيانات وتشفير المحادثات وفقاً لأعلى المعايير"
            },
            {
              icon: BarChart,
              title: "تحليلات شاملة",
              description: "رؤى تفصيلية عن أداء تدفقات الأتمتة والنتائج"
            }
          ].map((feature, index) => (
            <motion.div
              key={index}
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer: "لا، منصتنا سهلة الاستخدام وتتضمن واجهة سحب وإفلات بديهية لإنشاء تدفقات الأتمتة."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
