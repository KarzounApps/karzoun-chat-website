...
import { 
  Bell, ShoppingCart, MessageSquare, Calendar, 
  User, Clock, Tag, Database, Globe, ArrowRight,
  CheckCircle2, Zap, Repeat, Filter, Mail, 
  FileText, Users, Smartphone, Send, Heart,
  Layers, Workflow, BellRing, UserPlus, UserMinus
} from 'lucide-react';
    ...
    <div className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">
              محفزات متنوعة لبدء تدفقات الأتمتة
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto">
              اختر من بين عشرات المحفزات المختلفة لبدء تدفقات الأتمتة الخاصة بك، من أحداث المحادثات إلى أحداث التجارة الإلكترونية والمزيد
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {triggers[activeCategory].map((trigger, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <a href="#" className={`inline-flex items-center gap-1 ${trigger.textColor} hover:underline text-sm font-medium`}>
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="md:w-2/3">
              ...
              <p className="text-gray-600 mb-4">
                يمكنك إنشاء محفزات مخصصة باستخدام واجهة برمجة التطبيقات (API) أو الاتصال بأنظمة خارجية لبدء تدفقات الأتمتة الخاصة بك.
              </p>
