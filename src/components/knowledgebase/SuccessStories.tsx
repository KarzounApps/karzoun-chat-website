              ...
              <svg width="100%" height="100%">
                <defs>
                  <pattern id="quote-pattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                    <text x="0" y="30" fill="#2ca24c" fontSize="40">
                      &quot;
                    </text>
                  </pattern>
                </defs>
              ...
              <div className="flex flex-col md:flex-row gap-10 items-center">
                <div className="md:w-1/3 flex flex-col items-center">
                  ...
                  <div className="text-center">
                    <div className="text-xl font-bold text-gray-900">{successStories[activeStory].author}</div>
                    <div className="text-[#2ca24c]">{successStories[activeStory].position}</div>
                    <div className="text-gray-600">{successStories[activeStory].company}</div>
                  </div>
                </div>
            ...
            {successStories.map((_, index) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all ${
                  index === activeStory ? "bg-[#2ca24c] w-8" : "bg-gray-300 hover:bg-gray-400"
                }`}
