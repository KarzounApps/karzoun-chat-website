...
import { 
  FileText, ShoppingCart, Calendar, MessageSquare, 
  Headphones, School, Landmark, Home, ArrowRight,
  CheckCircle2, Star, Copy, Download, Share2, 
  ChevronLeft, ChevronRight, Search, Filter, 
  Smartphone, Send, Clock, User, Bot, Zap
} from 'lucide-react';
  ...
  const templates = [
    {
      ...
      rating: 4.8,
      downloads: 2450,
      image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80",
      preview: {
        messages: [
          { type: 'bot', text: 'مرحباً بك في متجرنا! كيف يمكنني مساعدتك اليوم؟' },
          { type: 'bot', text: 'يمكنك اختيار أحد الخيارات التالية:', options: ['تصفح المنتجات', 'عروض خاصة', 'تتبع طلب', 'التحدث مع موظف'] },
          { type: 'user', text: 'تصفح المنتجات' },
          { type: 'bot', text: 'رائع! ما هي فئة المنتجات التي تبحث عنها؟', options: ['ملابس', 'إلكترونيات', 'منزل وحديقة', 'مستلزمات رياضية'] }
        ]
      }
    },
    {
      ...
      rating: 4.9,
      downloads: 1890,
      image: "https://images.unsplash.com/photo-1606202598125-e2077bb5186d?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80",
      preview: {
        messages: [
          { type: 'bot', text: 'مرحباً بك في عيادة الصحة! كيف يمكنني مساعدتك اليوم؟' },
          { type: 'bot', text: 'يمكنك اختيار أحد الخيارات التالية:', options: ['حجز موعد جديد', 'تعديل موعد', 'إلغاء موعد', 'استفسار عام'] },
    ...
    },
    {
      ...
      rating: 4.7,
      downloads: 3200,
      image: "https://images.unsplash.com/photo-1581092921461-7d65ca45393a?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80",
      preview: {
        messages: [
          { type: 'bot', text: 'مرحباً بك في مركز الدعم الفني! كيف يمكنني مساعدتك اليوم؟' },
          { type: 'bot', text: 'يرجى اختيار نوع المشكلة التي تواجهها:', options: ['مشكلة في تسجيل الدخول', 'مشكلة في الدفع', 'مشكلة في المنتج', 'استفسار آخر'] },
    ...
    },
    {
      ...
      rating: 4.6,
      downloads: 1560,
      image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80",
      preview: {
        messages: [
          { type: 'bot', text: 'مرحباً بك في المساعد التعليمي! كيف يمكنني مساعدتك اليوم؟' },
          { type: 'bot', text: 'يمكنك اختيار أحد الخيارات التالية:', options: ['مراجعة دروس', 'حل تمارين', 'اختبارات تجريبية', 'موارد إضافية'] },
          { type: 'user', text: 'مراجعة دروس' },
          { type: 'bot', text: 'ممتاز! يرجى اختيار المادة التي ترغب في مراجعتها:', options: ['الرياضيات', 'العلوم', 'اللغة العربية', 'اللغة الإنجليزية'] }
        ]
      }
    },
    {
      ...
      preview: {
        messages: [
          ...
          { type: 'bot', text: 'يمكنك اختيار أحد الخيارات التالية:', options: ['الاستعلام عن الرصيد', 'تحويل أموال', 'كشف حساب', 'خدمات أخرى'] },
          { type: 'user', text: 'الاستعلام عن الرصيد' },
          { type: 'bot', text: 'للتحقق من رصيدك، يرجى تأكيد هويتك. هل ترغب في إرسال رمز التحقق إلى رقم هاتفك المسجل؟', options: ['نعم', 'لا'] }
        ]
      }
    },
    {
      ...
      rating: 4.4,
      downloads: 750,
      image: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&h=300&q=80",
      preview: {
        messages: [
          { type: 'bot', text: 'مرحباً بك في الوكالة العقارية! كيف يمكنني مساعدتك اليوم؟' },
          { type: 'bot', text: 'يمكنك اختيار أحد الخيارات التالية:', options: ['شراء عقار', 'إيجار عقار', 'بيع عقار', 'استفسار عام'] },
          { type: 'user', text: 'شراء عقار' },
          { type: 'bot', text: 'رائع! يرجى تحديد نوع العقار الذي تبحث عنه:', options: ['شقة', 'فيلا', 'أرض', 'مكتب تجاري'] }
        ]
      }
    }
  ];
