...
const categories = [
  {
    ...
    link: "/help/docs",
    items: ["دليل البدء السريع", "الأسئلة الشائعة", "أدلة المستخدم", "حل المشكلات"],
  },
  {
    icon: Code2,
    title: "وثائق API",
    ...
    link: "/help/api",
    items: ["مقدمة API", "المصادقة والتفويض", "نقاط النهاية", "أمثلة التكامل"],
  },
  {
    icon: Users,
    title: "وثائق الشركاء",
    ...
    link: "/help/partners",
    items: ["دليل الشركاء", "أفضل الممارسات", "أدوات التسويق", "برنامج العمولات"],
  },
  {
    ...
    link: "/help/community",
    items: ["النقاشات العامة", "مشاركة الحلول", "طلبات الميزات", "قصص النجاح"],
  },
];
...
export function HelpCenter() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-b from-gray-900 to-gray-800 text-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">كيف يمكننا مساعدتك؟</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map((category, index) => (
            ...
            >
              ...
              <a href={category.link} className="text-google-blue hover:underline flex items-center gap-1">
                استكشف المزيد
      ...
      <div className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">المواضيع الأكثر شيوعاً</h2>
      ...
      <div className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">موارد تعليمية</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="bg-gradient-to-r from-google-blue to-blue-600 py-24 text-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90">فريق الدعم الفني متواجد على مدار الساعة لمساعدتك</p>
