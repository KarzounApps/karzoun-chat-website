...
const countryRates: CountryRate[] = [
  {
    ...
    code: "SA",
    businessInitiatedRate: 0.0474,
    userInitiatedRate: 0.0079,
    currency: "USD",
  },
  {
...
const faqData = [
  {
    ...
    answer:
      "رسائل واتساب للأعمال (WhatsApp Business API) هي خدمة تتيح للشركات التواصل مع عملائها عبر منصة واتساب. يمكن للشركات إرسال إشعارات، وتقديم خدمة العملاء، وإجراء محادثات تسويقية مع العملاء الذين اختاروا التواصل معهم.",
  },
  {
    question: "كيف يتم احتساب تكاليف رسائل واتساب للأعمال؟",
    answer:
      "يعتمد تسعير رسائل واتساب للأعمال على نوع الرسالة (بدأها العمل أو بدأها المستخدم) والدولة التي يتواجد فيها المستلم. الرسائل التي يبدأها العمل عادة ما تكون أعلى سعرًا من الرسائل التي يبدأها المستخدم. تختلف الأسعار أيضًا حسب البلد.",
  },
  {
    question: "ما الفرق بين الرسائل التي يبدأها العمل والرسائل التي يبدأها المستخدم؟",
    answer:
      "الرسائل التي يبدأها العمل هي رسائل ترسلها الشركة للمستخدم، مثل الإشعارات والرسائل التسويقية. الرسائل التي يبدأها المستخدم هي محادثات يبدأها العميل، أو ردود على رسائل الشركة ضمن نافذة الـ 24 ساعة.",
  },
  {
    question: "ما هي نافذة الـ 24 ساعة؟",
    answer:
      "عندما يرسل المستخدم رسالة إلى عملك، يفتح ذلك 'نافذة محادثة' مدتها 24 ساعة. خلال هذه النافذة، يمكنك إرسال رسائل غير منظمة (رسائل حرة) إلى المستخدم بتكلفة 'رسائل يبدأها المستخدم' المنخفضة. بعد انتهاء النافذة، يجب استخدام قوالب رسائل معتمدة بتكلفة 'رسائل يبدأها العمل' الأعلى.",
  },
  {
    question: "هل هناك رسوم إضافية لاستخدام واتساب للأعمال؟",
    answer:
      "بالإضافة إلى رسوم الرسائل، قد تكون هناك تكاليف إضافية مثل رسوم إعداد حساب واتساب للأعمال، ورسوم الاشتراك الشهري لمنصات إدارة الرسائل مثل كرزون، ورسوم خدمات إضافية مثل الروبوتات والتكاملات.",
  },
  {
    question: "هل يمكنني إرسال رسائل تسويقية عبر واتساب للأعمال؟",
    answer:
      "نعم، يمكنك إرسال رسائل تسويقية، ولكن يجب أن تكون عبر قوالب معتمدة من واتساب، ويجب أن يكون المستخدم قد وافق صراحةً على تلقي هذه الرسائل. تخضع الرسائل التسويقية لتكلفة 'رسائل يبدأها العمل'.",
  },
  {
    question: "كيف يمكنني تقليل تكاليف رسائل واتساب للأعمال؟",
    answer:
      "يمكنك تقليل التكاليف من خلال: تحسين استراتيجية الرسائل للاستفادة من نافذة الـ 24 ساعة، استخدام الروبوتات للرد الآلي على الاستفسارات الشائعة، تحسين جودة المحتوى لزيادة معدلات المشاركة، واستخدام التقسيم الفعال للجمهور لإرسال رسائل أكثر استهدافًا.",
  },
  {
    question: "هل تختلف أسعار الرسائل حسب نوع المحتوى؟",
    answer:
      "لا، لا تختلف الأسعار حسب نوع المحتوى (نص، صورة، فيديو، ملف)، بل تعتمد فقط على نوع الرسالة (بدأها العمل أو بدأها المستخدم) والدولة التي يتواجد فيها المستلم.",
  },
];
...
export function WabaCostCalculator() {
  ...
  const calculateCosts = () => {
    ...
    const messageBreakdown = messageTypes.map((type) => {
      ...
      const rate =
        type.category === "business" ? selectedCountry.businessInitiatedRate : selectedCountry.userInitiatedRate;
    ...
    const businessInitiatedPercentage = totalMessages > 0 ? (businessInitiatedCount / totalMessages) * 100 : 0;

    const userInitiatedPercentage = totalMessages > 0 ? (userInitiatedCount / totalMessages) * 100 : 0;
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">حاسبة تكاليف واتساب للأعمال</h1>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-colors ${
                    activeTab === "calculator" ? "bg-white text-blue-700" : "bg-blue-700 text-white hover:bg-blue-600"
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-colors ${
                    activeTab === "pricing" ? "bg-white text-blue-700" : "bg-blue-700 text-white hover:bg-blue-600"
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-colors ${
                    activeTab === "faq" ? "bg-white text-blue-700" : "bg-blue-700 text-white hover:bg-blue-600"
                  }`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                {/* Country Selection */}
                <div className="mb-6">
                  <label className="block text-sm font-medium text-gray-700 mb-2">اختر الدولة</label>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="space-y-4">
                        {messageTypes
                          .filter((type) => type.category === "business")
                          .map((type) => (
                            <div key={type.id}>
                              <div className="flex items-center justify-between mb-1">
                                ...
                                <div className="text-xs text-gray-500">
                                  {formatCurrency(selectedCountry.businessInitiatedRate, selectedCountry.currency)} /
                                  رسالة
                                </div>
                              </div>
                              <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        {messageTypes
                          .filter((type) => type.category === "user")
                          .map((type) => (
                            <div key={type.id}>
                              <div className="flex items-center justify-between mb-1">
                                <label className="text-sm font-medium text-gray-700 flex items-center">
                      ...
                      <div className="mb-6">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-sm font-medium">
                            {calculationResult.businessInitiatedPercentage.toFixed(1)}%
                          </span>
                        </div>
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                          ...
                          <span className="text-sm font-medium">
                            {calculationResult.userInitiatedPercentage.toFixed(1)}%
                          </span>
                        </div>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        ...
                        <span className="text-sm text-gray-700">
                          استفد من نافذة الـ 24 ساعة للرد على العملاء بتكلفة أقل
                        </span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 ml-2 flex-shrink-0 mt-0.5" />
                        <span className="text-sm text-gray-700">
                          استخدم الروبوتات للرد الآلي على الاستفسارات الشائعة
                        </span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 ml-2 flex-shrink-0 mt-0.5" />
                      ...
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 ml-2 flex-shrink-0 mt-0.5" />
                        <span className="text-sm text-gray-700">
                          استخدم التقسيم الفعال للجمهور لإرسال رسائل أكثر استهدافًا
                        </span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 ml-2 flex-shrink-0 mt-0.5" />
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700">
                      الأسعار المعروضة هي الأسعار الرسمية من Meta لرسائل واتساب للأعمال. قد تختلف الأسعار الفعلية حسب
                      مزود الخدمة أو الشريك الذي تتعامل معه. الأسعار قابلة للتغيير من قبل Meta في أي وقت.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-4">
                  <div className="border-r-4 border-blue-500 pr-4">
                    ...
                    <p className="text-sm text-gray-600">
                      هي الرسائل التي ترسلها الشركة للمستخدم خارج نافذة الـ 24 ساعة. تشمل الإشعارات، والرسائل التسويقية،
                      والتذكيرات، وغيرها. تكون عادة أعلى سعرًا.
                    </p>
                  </div>
                  ...
                  <div className="border-r-4 border-green-500 pr-4">
                    ...
                    <p className="text-sm text-gray-600">
                      هي الرسائل التي يبدأها العميل، أو الردود على رسائل الشركة ضمن نافذة الـ 24 ساعة. تكون عادة أقل
                      سعرًا بشكل ملحوظ من الرسائل التي يبدأها العمل.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    عندما يرسل المستخدم رسالة إلى عملك، يفتح ذلك &quot;نافذة محادثة&quot; مدتها 24 ساعة. خلال هذه
                    النافذة، يمكنك إرسال رسائل غير منظمة (رسائل حرة) بتكلفة &quot;رسائل يبدأها المستخدم&quot; المنخفضة.
                  </p>
                  <div className="bg-yellow-50 border-r-4 border-yellow-500 p-3 pr-4">
                    <p className="text-sm text-yellow-800">
                      بعد انتهاء نافذة الـ 24 ساعة، يجب استخدام قوالب رسائل معتمدة بتكلفة &quot;رسائل يبدأها العمل&quot;
                      الأعلى.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        صمم استراتيجية تشجع العملاء على بدء المحادثات، مما يزيد من نسبة الرسائل التي يبدأها المستخدم
                        ويقلل التكاليف.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        قدم محتوى قيمًا يشجع العملاء على الرد، مما يفتح نافذة الـ 24 ساعة ويقلل من الحاجة إلى رسائل
                        يبدأها العمل.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  ...
                  <p className="text-sm text-blue-700 mb-3">
                    تختلف النسبة المثالية حسب نوع العمل، ولكن بشكل عام، كلما زادت نسبة الرسائل التي يبدأها المستخدم،
                    كلما انخفضت التكاليف الإجمالية.
                  </p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mb-4">
                    إذا كانت لديك أسئلة أخرى حول تكاليف واتساب للأعمال أو كيفية تحسين استراتيجية الرسائل الخاصة بك، فلا
                    تتردد في التواصل مع فريق الدعم لدينا.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <a
                      href="#"
                      className="inline-flex items-center gap-1 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition-colors"
                    >
                    ...
                    <a
                      href="#"
                      className="inline-flex items-center gap-1 bg-white text-blue-700 border border-blue-200 px-4 py-2 rounded-lg text-sm hover:bg-blue-50 transition-colors"
                    >
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">جاهز لبدء استخدام واتساب للأعمال مع كرزون؟</h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
