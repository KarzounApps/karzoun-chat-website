  ...
  return (
    <div className="min-h-screen">
                    ...
                    >
                      <div
                        className={`max-w-[80%] rounded-2xl p-4 ${
                          msg.type === "visitor" ? "bg-google-blue text-white" : "bg-gray-100 text-gray-800"
                        }`}
                      >
                        {msg.message}
                      </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">ميزات متقدمة لتجربة دردشة مثالية</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">كل ما تحتاجه لتقديم تجربة دردشة احترافية لعملائك</p>
          </div>
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-lg transition-colors ${
                  activeTab === tab.id ? "bg-google-blue text-white" : "text-gray-600 hover:text-gray-900"
                }`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {activeTab === "overview" && (
              <>
                ...
                >
                  <h3 className="text-2xl font-bold mb-6">محادثة مباشرة متطورة لموقعك</h3>
                  <div className="space-y-6">
                    <p className="text-gray-600">
                      قدم تجربة دردشة احترافية لزوار موقعك مع ميزات متقدمة تساعدك على تحسين خدمة العملاء وزيادة
                      المبيعات.
                    </p>
                    <div className="space-y-4">
                      {[
            ...
            {activeTab === "customization" && (
              <>
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="text-2xl font-bold mb-6">خيارات تخصيص شاملة</h3>
                  <div className="space-y-6">
                    <p className="text-gray-600">خصص شكل ومظهر المحادثة المباشرة لتتناسب مع هوية علامتك التجارية.</p>
            ...
            {activeTab === "automation" && (
              <>
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="text-2xl font-bold mb-6">أتمتة ذكية للمحادثات</h3>
                  <div className="space-y-6">
                    <p className="text-gray-600">استخدم الذكاء الاصطناعي والأتمتة لتحسين كفاءة خدمة العملاء.</p>
                    <div className="space-y-4">
                      {[
            ...
            {activeTab === "security" && (
              <>
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="text-2xl font-bold mb-6">حماية وأمان متقدم</h3>
                  <div className="space-y-6">
                    <p className="text-gray-600">حماية قوية لبيانات المحادثات وخصوصية المستخدمين.</p>
                    <div className="space-y-4">
                      {[
            ...
            {activeTab === "analytics" && (
              <>
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <h3 className="text-2xl font-bold mb-6">تحليلات وتقارير متقدمة</h3>
                  <div className="space-y-6">
                    <p className="text-gray-600">تحليلات شاملة لفهم أداء خدمة العملاء وتحسين تجربة المستخدم.</p>
                    <div className="space-y-4">
                      {[
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">تكامل سلس مع أدواتك المفضلة</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">ربط سهل مع مختلف الأنظمة والتطبيقات لتحسين سير العمل</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {["Salesforce", "HubSpot", "Zendesk", "Slack", "Microsoft Teams", "Shopify", "WooCommerce", "Intercom"].map(
              (platform, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
