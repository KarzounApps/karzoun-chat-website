  ...
  return (
    <div className="min-h-screen">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              <h4 className="font-medium text-gray-900 truncate">{conv.customer.name}</h4>
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              {conv.assigned && <span className="text-xs text-gray-500">{conv.assigned}</span>}
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">كل قنوات التواصل في مكان واحد</h2>
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">قنوات متعددة، منصة واحدة</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">تواصل مع عملائك عبر قنواتهم المفضلة من منصة موحدة</p>
          </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">تعاون فريق أفضل، خدمة عملاء أسرع</h2>
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">تحليلات شاملة لتحسين الأداء</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">فهم أفضل لأداء خدمة العملاء مع تقارير وتحليلات متقدمة</p>
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">جاهز لتوحيد قنوات تواصلك مع العملاء؟</h2>
