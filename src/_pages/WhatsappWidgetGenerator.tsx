...
const defaultConfig: WidgetConfig = {
  ...
  avatar:
    "https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80",
  companyName: "شركتك",
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-colors ${
                    activeTab === "design" ? "bg-white text-blue-700" : "bg-blue-700 text-white hover:bg-blue-600"
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-colors ${
                    activeTab === "settings" ? "bg-white text-blue-700" : "bg-blue-700 text-white hover:bg-blue-600"
                  }`}
                >
              ...
              {activeTab === "design" && (
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    {/* Layout Selection */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">نوع الأداة</label>
                    ...
                    {/* Position Selection */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">موقع الأداة</label>
                      <div className="grid grid-cols-2 gap-3">
                        {[
                    ...
                    {config.layout === "card" && (
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">خيارات البطاقة</label>
                        <div className="space-y-3">
              ...
              {activeTab === "settings" && (
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    {/* WhatsApp Settings */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">إعدادات واتساب</label>
                      <div className="space-y-4">
                        <div>
                          <label className="block text-sm text-gray-500 mb-1">رقم الهاتف (مع رمز الدولة)</label>
                          <div className="flex">
                          ...
                          <p className="mt-1 text-xs text-gray-500">مثال: 966500000000 (بدون + أو مسافات)</p>
                        </div>

                        <div>
                          <label className="block text-sm text-gray-500 mb-1">الرسالة الافتراضية</label>
                          <textarea
                          ...
                          />
                          <p className="mt-1 text-xs text-gray-500">الرسالة التي ستظهر تلقائياً في واتساب</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Widget Content */}
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">محتوى الأداة</label>
                      <div className="space-y-4">
                        {config.layout === "card" && (
                          <div>
                            <label className="block text-sm text-gray-500 mb-1">رسالة الترحيب</label>
                            <textarea
                        ...
                        <div>
                          <label className="block text-sm text-gray-500 mb-1">نص الزر</label>
                          <input
                            type="text"
                        ...
                        {config.layout === "card" && config.showAvatar && (
                          <div>
                            <label className="block text-sm text-gray-500 mb-1">رابط الصورة الرمزية</label>
                            <input
                              type="text"
                              value={config.avatar}
                        ...
                        {config.layout === "card" && config.showAgentName && (
                          <div>
                            <label className="block text-sm text-gray-500 mb-1">اسم الوكيل</label>
                            <input
                              type="text"
                    ...
                    <div>
                      ...
                      {showAdvancedSettings && (
                        <div className="mt-4 space-y-4 p-4 bg-gray-50 rounded-lg">
                          <div>
                            <label className="block text-sm text-gray-500 mb-1">سلوك الفتح</label>
                          ...
                          <div>
                            <label className="block text-sm text-gray-500 mb-1">مؤشر Z-index</label>
                            <input
                              type="number"
                              min="1"
                              value={config.zIndex}
                              ...
                              className="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                            />
                            <p className="mt-1 text-xs text-gray-500">يحدد ترتيب طبقات العناصر في الصفحة</p>
                          </div>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`p-2 rounded-md ${
                        previewMode === "desktop" ? "bg-blue-100 text-blue-700" : "text-gray-500 hover:bg-gray-100"
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-md ${
                        previewMode === "mobile" ? "bg-blue-100 text-blue-700" : "text-gray-500 hover:bg-gray-100"
                      }`}
                    >
                  ...
                  >
                    {config.layout === "bubble" ? (
                      ...
                      >
                        ...
                        >
                          {config.showAvatar && (
                            <img src={config.avatar} alt="Agent" className="w-10 h-10 rounded-full object-cover" />
                          )}
                          <div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                <div className="mb-4">
                  <p className="text-gray-600 mb-4">
                    انسخ الكود التالي والصقه في موقعك قبل علامة الإغلاق{" "}
                    <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">&lt;/body&gt;</code> لإضافة أداة واتساب.
                  </p>
                ...
                <div className="space-y-6">
                    ...
                    <div className="mr-4">
                      ...
                      <div className="bg-gray-50 p-3 rounded-lg">
                        ...
                        <ul className="text-sm text-gray-500 space-y-1 list-disc list-inside">
                          <li>
                            ووردبريس: انتقل إلى &quot;المظهر&quot; ثم &quot;محرر القوالب&quot; أو استخدم إضافة لإضافة
                            أكواد HTML
                          </li>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="mr-4">
                      ...
                      <p className="text-gray-600 mb-2">
                        الصق الكود قبل علامة الإغلاق{" "}
                        <code className="bg-gray-100 px-1 py-0.5 rounded">&lt;/body&gt;</code> في صفحات موقعك.
                      </p>
                      <div className="bg-gray-50 p-3 rounded-lg">
                        <div className="flex items-center text-sm text-gray-500">
                          <Info className="h-4 w-4 text-blue-500 ml-2" />
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">إليك إجابات على الأسئلة الأكثر شيوعًا حول أداة واتساب للمواقع</p>
        </div>
          ...
          {[
            {
              ...
              answer:
                "نعم، يمكنك تخصيص شكل الأداة بالكامل بما في ذلك الألوان والموقع والنصوص والصور الرمزية وغيرها من الخيارات من خلال واجهة المنشئ سهلة الاستخدام.",
            },
            {
              question: "هل أحتاج إلى مهارات برمجية لاستخدام الأداة؟",
              answer:
                "لا، لا تحتاج إلى أي مهارات برمجية. ما عليك سوى تخصيص الأداة باستخدام واجهة المنشئ، ثم نسخ الكود ولصقه في موقعك. الأمر بهذه البساطة!",
            },
            {
              question: "هل الأداة متوافقة مع جميع أنظمة إدارة المحتوى؟",
              answer:
                "نعم، الأداة متوافقة مع جميع أنظمة إدارة المحتوى الشائعة مثل ووردبريس وشوبيفاي وويكس وسكوير سبيس وغيرها. يمكن إضافتها إلى أي موقع يدعم إضافة أكواد HTML مخصصة.",
            },
            {
              question: "هل يمكنني استخدام الأداة على الهاتف المحمول؟",
              answer:
                "نعم، الأداة متوافقة تمامًا مع الأجهزة المحمولة وتعمل بشكل جيد على جميع أحجام الشاشات. يمكنك معاينة كيفية ظهورها على الهاتف المحمول من خلال وضع المعاينة المخصص.",
            },
            {
              question: "هل يمكنني تغيير إعدادات الأداة بعد تثبيتها؟",
              answer:
                "نعم، يمكنك العودة إلى منشئ الأداة في أي وقت لتعديل الإعدادات والحصول على كود جديد. ثم قم باستبدال الكود القديم في موقعك بالكود الجديد.",
            },
            {
              question: "هل الأداة مجانية للاستخدام؟",
              answer:
                "نعم، الأداة مجانية تمامًا للاستخدام ولا توجد أي رسوم خفية. يمكنك إنشاء وتخصيص واستخدام الأداة على موقعك بدون أي تكلفة.",
            },
          ].map((faq, index) => (
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">جاهز لتحسين تواصلك مع العملاء؟</h2>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto mb-8">
